...
| Ninety days of Ethereum mainnet are held, with no gap | **791,200** consecutive heights, 25,179,001 – 25,970,200 (≈ 109.9 days), read bit by bit from the mirror's bitmap. 792,101 heights held in all, added by 899 `mirror()` calls ([every call](./docs/CAMPAIGN-mainnet.md)) |
...
| Proving a span gap-free is one read per 256 blocks | sealing **131,072** blocks cost **1,280,230 gas** — [`0x90d9…11a8`](https://creditcoin-testnet.blockscout.com/tx/0x90d928710400454b263208f6ee194cc4dd1a60a18fe37316acfac84f6c8a11a8); 20 spans sealed |
...
| False negative claims die on-chain, and half of every bond burns | 13 refutations on the v3 board, **13.50 tCTC** paid to the hunter and **13.50 tCTC** burned to `0x…dEaD`. Listed below |
...
### The mainnet board (25,314,741 – 25,970,100, five sealed spans)
...
| 24 | lie | EmptySet | USDC · Blacklisted | **Refuted** | [`0x12e7…6b23`](https://creditcoin-testnet.blockscout.com/tx/0x12e7d476354079076a234bb0fbe706f5dc7fd2f38350a8d81abdac6970d86b23) · paid 1.00 · burned 1.00 |
| 26 | lie | EmptySet | Spark · LiquidationCall | **Refuted** | [`0x1e5e…3391`](https://creditcoin-testnet.blockscout.com/tx/0x1e5ee3c8cd86a9ecfd7b54165e21cbc9e6aa0d09998ac65ecb50998dd0203391) · paid 1.00 · burned 1.00 |
...
| 27 | bounty | EmptySet | Spark · LiquidationCall | Open | left open for anyone; the house hunter waits six days |
...
| 25 | clean | EmptySet | USDC · Blacklisted | Open | — |
| 28 | complete | CompleteSet | Chainlink ETH/USD · AnswerUpdated | Open | — |
...
| Bounties are worth hunting | refutations on this board cost **372,582–4,046,311 gas** each, against bonds of 2–3 tCTC of which half is paid out. An incentive argument, not a proof |
...
- **The prover's archiver would not serve 25,186,001 – 25,187,000.** Every window touching it failed with
  ...
  below the unbroken run: 2 runs, 7,000 heights unheld inside the range. Nothing above it is affected.
...
- **The Telegram bot is live and has no users.** [@MandateDeskBot](https://t.me/MandateDeskBot) answers `/assess`,
  `/hunt` and `/bounty` from the same contracts as the site and holds no key. Its existence is a channel, not a
  user count; nobody has messaged it who is not us.
