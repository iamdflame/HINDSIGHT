 ...
 *   npx hindsight verify 0x… --prover              take the path from Gluwa's prover instead
 *   npx hindsight verify 0x… --chain 1             Sepolia
 *   npx hindsight coverage [--chain 1]             what the archive currently holds
 *   npx hindsight notarise 0x…                     needs PRIVATE_KEY; the one step that costs gas
 *
